...
This command drops any tables that seem to be remnants like the above mentioned. It will attempt a partial backup of the tables before dropping them. In case these tables were required and were dropped erroneously, you can restore them in your site's database using the `partial-restore` command.
